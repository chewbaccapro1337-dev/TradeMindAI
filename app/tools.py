...
Проанализируй именно выбранный инструмент.
...
Если инструмент криптовалютный:
анализируй как BTC/крипто.

Если инструмент Forex:
анализируй как валютную пару.
Не упоминай другие классы активов без необходимости.
